    ...
    <>
      ...
      <section className="min-h-screen bg-gray-50 px-6 py-24">
        <div className="mx-auto max-w-3xl rounded-2xl bg-white p-8 shadow-lg">
          ...
          <form
            action="https://formsubmit.co/zarakinsresources@gmail.com"
            method="POST"
            className="space-y-5"
          >
            <input
              type="hidden"
              name="_subject"
              value="New message from Zarakins website"
            />
      ...
      <section className="bg-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="overflow-hidden rounded-2xl shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.385570376982!2d3.30107907524054!3d6.472747993519027!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b897af1fc8185%3A0xe706456537c80a16!2sTop%2010%20Mall!5e0!3m2!1sen!2sng!4v1780431547790!5m2!1sen!2sng"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen=""
